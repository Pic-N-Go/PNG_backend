...
import com.project.picngo.community.domain.CommunityPost;
...
public interface CommunityPostRepository extends JpaRepository<CommunityPost, Long> {
    ...
    java.util.Optional<CommunityPost> findByIdForUpdate(@Param("postId") Long postId);
    ...
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("update CommunityPost p set p.bookmarkCount = p.bookmarkCount + :delta where p.id = :postId")
