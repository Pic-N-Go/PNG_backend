...
-- ============================================================
-- 출사알림 (1~101번 유저 전원 스팟 1번 성산일출봉 & 2번 함덕 등록)
-- ============================================================
...
SELECT id, 'MORNING' FROM spot_alert
UNION ALL
SELECT id, 'SUNRISE' FROM spot_alert WHERE spot_id = 1
UNION ALL
SELECT id, 'SUNSET' FROM spot_alert
...
SELECT id, 'CLEAR' FROM spot_alert
UNION ALL
SELECT id, 'CLOUDY' FROM spot_alert
